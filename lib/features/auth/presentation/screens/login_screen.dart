...
import 'package:e_commerce_app/features/auth/data/dataSources/remoteDataSource/auth_remote_ds_imp.dart';
import 'package:e_commerce_app/features/auth/data/repo/auth_repo_impl.dart';
...
import 'package:e_commerce_app/features/auth/presentation/widgets/custom_auth_text_filed.dart';
    ...
    return BlocProvider(
      ...
      child: BlocListener<AuthCubit, AuthState>(
        ...
        child: Scaffold(
          ...
          body: Padding(
            padding: const EdgeInsets.symmetric(horizontal: ConstantDoubleValues.s16),
            child: Form(
              key: formKey,
              child: Column(
                ...
                children: [
                    ...
                    child: Text(
                      ...
                      style: GoogleFonts.poppins(
                        textStyle: const TextStyle(
                            ...
                            fontSize: ConstantDoubleValues.s20,
                  ...
                  Padding(
                    padding: const EdgeInsets.only(top: ConstantDoubleValues.s16),
                    child: Align(
                      ...
                      child: Text(
                        ...
                        style: GoogleFonts.poppins(
                          textStyle: const TextStyle(
                              color: AppColor.whiteColor,
                              fontSize: ConstantDoubleValues.s18,
                  ...
                  Padding(
                    padding: const EdgeInsets.only(top: ConstantDoubleValues.s24),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text(
                          ...
                          style: GoogleFonts.poppins(
                            textStyle: const TextStyle(
                                color: AppColor.whiteColor,
                                fontSize:ConstantDoubleValues.s16,
